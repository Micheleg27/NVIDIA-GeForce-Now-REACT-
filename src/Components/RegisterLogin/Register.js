		...
		<div>
			...
			<div className="d-flex flex-column align-items-center justify-content-center register-container">
				<div className="d-flex flex-column align-items-center justify-content-center form-button-container">
					...
					<form action="/register" method="POST" className="was-validated">
						<div className="form-floating">
							<div className="mb-3">
								<input
									...
									required
								/>
								<div className="invalid-feedback">Username obbligatorio !</div>
							</div>
							<div className="mb-3">
								<input
									className="form-control"
							...
							<div className="mb-5">
								<input
									...
									required
								/>
								<div className="invalid-feedback">min 8 caratteri max 16 !</div>
							</div>
						</div>
