function ScaricaCloudGaming() {
	return (
		<div classNameName="cl-container">
			<div className="text-container text-light"> 
				...
				<h2 id="h2-cl-container">
					App native
				</h2>
				<h3>La migliore esperienza complessiva</h3>
			</div>

			<div classNameName="d-flex justify-content-center" id="cl-logo-container">
				<div className="d-flex" id="cl-container-mobile">
					<div className="cl-img-container">
						<div>
							...
							<div className="cl-btn-container">
								<button className="cl-btn" id="btn-dw-1">
									Download
								</button>
							</div>
						</div>
					...
					<div className="cl-img-container">
						<div>
							...
							<div className="cl-btn-container">
								<button className="cl-btn" id="btn-dw-2">
									Download
								</button>
							</div>
						</div>
			...
			<div classNameName="d-flex gap-div" id="cl-container-mobile">
				<div className="cl-img-container">
					<div>
						<img
							id="img-icon"
