        ...
        <div className="row ">
            <div className="ad-logo">
                ...
                <div className="ad-global-footer-region">
                    <a id="a" href="https://www.nvidia.com/en-us/geforce-now/location-selector/" target="_self">
                        <span className="ad-global-footer__region__label">
                            IT - ITALIA
                        </span>
                    </a>
                </div>
            ...
            <ul className="list-unstyled list-inline">
                <li className="list-inline-item">
                    <a id="a" href="https://www.nvidia.com/it-it/about-nvidia/privacy-policy/">Privacy Notice <span
                        id="ad-span">|</span></a>
                </li>
                <li className="list-inline-item">
                    <a id="a" href="https://www.nvidia.com/it-it/about-nvidia/privacy-center/">Gestisci la privacy <span
                        id="ad-span">|</span></a>
                </li>
                <li className="list-inline-item">
                    <a id="a" href="https://www.nvidia.com/it-it/about-nvidia/legal-info/">Legali <span id="ad-span">|</span></a>
                </li>
                <li className="list-inline-item">
                    <a id="a" href="https://www.nvidia.com/it-it/about-nvidia/accessibility/">Accessibilità <span
                        id="ad-span">|</span></a>
                </li>
                <li className="list-inline-item">
                    <a id="a" href="https://www.nvidia.com/it-it/security/">Sicurezza dei prodotti <span id="ad-span">|</span></a>
                </li>
                <li className="list-inline-item">
                    <a id="a" href="https://www.nvidia.com/it-it/contact/">Contatti</a>
                </li>
            </ul>
